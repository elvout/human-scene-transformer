...
def jrdb_preprocess_train_worker(input_path, output_path, scene):
  """Preprocesses the raw train split of JRDB."""
...
def jrdb_preprocess_train(input_path, output_path):
  ...
  scenes = utils.list_scenes(os.path.join(input_path, "train_dataset"))
